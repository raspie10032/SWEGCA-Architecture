...
from tinylm_slicer.mosaic_omni import WorldState
...
class AccumulatorDecision:
    """Snapshot-bound decision plus the hypothesis and evidence that produced it."""
...
def assess_accumulator(
    ...
    decision = AccumulatorDecision(
        ...
        evidence_addresses=tuple(sorted(state.seen_addresses)),
    )
